...
* [Docker Compose Support](https://docs.spring.io/spring-boot/4.0.3/reference/features/dev-servicos.html#features.dev-servicos.docker-compose)
...
* [Thymeleaf](https://docs.spring.io/spring-boot/4.0.3/reference/web/servlet.html#web.servlet.spring-mvc.modelo-engines)
...
This plugin can be used to generate client files for accessing remote GraphQL servicos.
...
In this file, the following servicos have been defined:

...
public final class TradutorInterface {
    ...
    private static String textoNome(String nome) {
        ...
        return switch (nome.trim().toUpperCase()) {
            ...
            case "AUTO_RENEW" -> "Renovação automática";
            ...
            case "SENT" -> "Enviada";
            case "OPEN" -> "Aberta";
            case "CONTRACT_EXPIRING" -> "Contrato vencendo";
            case "CERTIFICATE_EXPIRING" -> "Certificado vencendo";
            case "INSTALLMENT_OVERDUE" -> "Parcela vencida";
            case "VISIT_UPCOMING" -> "Visita próxima";
            default -> nome;
        };
    }
}
